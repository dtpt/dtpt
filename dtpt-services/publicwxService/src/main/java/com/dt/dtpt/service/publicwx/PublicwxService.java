...
public interface PublicwxService {
	 ...
	 */
	public Result getWxPublicByShid(String shId);
	 ...
	 */
	public Result isManerger(String userOpenID,String shId);
	 ...
	 */
	public Result attentionPublic(WxUserPublic wxUserPublic,String shId);
}
